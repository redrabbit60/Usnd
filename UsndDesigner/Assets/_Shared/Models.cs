...
namespace SkySoundDesigner
{
    ...
    public class MasterSettings
    {
        ...
        public List<MasterSet> Items { get; set; } = new List<MasterSet>();
    }
    ...
    public class CategorySettings
    {
        ...
        public List<CategorySet> Items { get; set; } = new List<CategorySet>();
    }
    ...
    public class LabelSettings
    {
        ...
        [XmlElement("LabelSet")]
        public List<LabelSet> Items { get; set; } = new List<LabelSet>();
    }
